...
cd /opt
wget http://ftp.man.poznan.pl/apache/flink/flink-1.6.2/flink-1.6.2-bin-scala_2.11.tgz
tar xzvf ./flink-1.6.2-bin-scala_2.11.tgz
ln -s /opt/flink-1.6.2 /opt/apache-flink
